    ...
    <div class="container mt-6">
        <div class="row gx-lg-4 gx-xl-5 justify-content-between thong-tin-khoa-hoc">
            ...
            <div class="col-lg-8 mb-5">
                ...
                <?php if($course): ?>
                    <p class="fw-bold fs-2 mt-3 text-sm-center text-md-end" id="cartTotal">T?ng: <?php echo e($displayPrice); ?></p>
                <?php endif; ?>
            ...
            <div class="col-lg-3 d-flex flex-column mb-6">
                ...
                <div
                    ...
                    <p class="text-center fs-4 fst-italic" id="summaryCount">(<?php echo e($course ? '1 khóa h?c' : 'Chưa có khóa h?c'); ?>)</p>
                    ...
                    <p class="text-center fs-4 mb-0">N?i dung chuy?n kho?n: <?php echo e($transferNoteSafe); ?></p>
