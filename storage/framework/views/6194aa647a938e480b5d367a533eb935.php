                ...
                <div class="shadow-sm rounded-5 p-sm-2 pt-sm-4 p-md-4 p-xl-5 d-flex flex-wrap">
                    <div class="col-sm-12 col-lg-3 col-xxl-2 ps-0 pe-3">
                        ...
                        <div class="d-flex justify-content-center mb-md-2 mb-lg-4 d-block d-lg-none">
                            <img class="rounded-circle" src="/om-front/img/youtube-icon.png" alt="" width="90px"
                                height="90px">
                        </div>
            ...
            <div class="col-sm-12 col-lg-4 mb-4">
                <div class="shadow-sm rounded-5 p-5 height-100 d-flex flex-column">
                    ...
                    <ul class="fst-italic fs-4">
                        ...
                        <li>Lắng nghe tình huống thực tế của bạn.</li>
                        <li>Phân tích nguyên nhân gốc rễ.</li>
                        <li>Đưa ra chiến lược, hướng đi và hành động cụ thể phù hợp với mô hình kinh doanh của bạn.</li>
                        <li>Không có giáo trình cố định. Nội dung buổi coaching xoay quanh chính vấn đề của bạn.</li>
                        <li>Đề xuất các khóa học phù hợp (miễn phí 100%) để cập nhật thêm kiến thức.</li>
                    </ul>
                    <p class="fs-4 fw-bold fst-italic mt-6">Chi phí: 500.000 VNĐ / buổi</p>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-lg-4 mb-4">
                <div class="shadow-sm rounded-5 p-5 height-100 d-flex flex-column">
                    ...
                    <p class="fs-4 fst-italic">Cấu trúc lộ trình học tùy vào mục tiêu của học viên. Mỗi học viên được
                        ...
                        đang hoạt động.</p>
                    <p class="fs-4 fst-italic ">Thời gian và hình thức học tương tự buổi lẻ. Học viên sẽ được:</p>
                    <ul class="fst-italic fs-4">
                        ...
                        <li>Có thể vận hành chiến dịch Marketing hoặc quy trình bán hàng hoàn chỉnh sau khi hoàn thành
                            chương trình.</li>
                            <li>Cung cấp các tài liệu vận dụng liên quan.</li>
                    </ul>
            ...
            <div class="col-lg-6 mb-5">
                <div
                    ...
                    <div class="shadow-sm rounded-pill d-flex justify-content-center p-1 ms-auto me-auto ">
                        <button type="button"
                            class="btn btn-primary me-2 p-1 px-3 fs-4 fw-bold rounded-4 rounded-pill plan-btn active"
                            data-plan="buoi_le">
                            Buổi lẻ
                        </button>
                        <button type="button" class="btn btn-light p-1 px-3 fs-4 fw-bold rounded-4 plan-btn"
                            data-plan="lo_trinh">
                            Lộ trình
                        </button>
                    </div>
