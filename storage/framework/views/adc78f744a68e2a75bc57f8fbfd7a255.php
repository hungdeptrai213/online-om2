            ...
            <div style="display:grid;gap:6px;">
                ...
                <?php if($thumbUrl): ?>
                    <div style="display:flex;gap:10px;align-items:center;">
                        <img src="<?php echo e($thumbUrl); ?>" alt="Thumbnail hiện tại" style="height:80px;border-radius:8px;border:1px solid #e5e7eb;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\online-om\resources\views/admin/documents/edit.blade.php ENDPATH**/ ?>