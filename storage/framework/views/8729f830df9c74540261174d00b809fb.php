...
<?php $__env->startSection('content'); ?>
    <div class="page-card">
        ...
        <form method="post" action="<?php echo e(route('admin.documents.update', ['document' => $document->id])); ?>" style="display:grid;gap:16px;">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display:grid;gap:6px;">
                ...
                <input id="link" name="link" type="text" value="<?php echo e(old('link', $document->link)); ?>"
                       style="padding:10px 12px;border:1px solid #ced4da;border-radius:8px;">
