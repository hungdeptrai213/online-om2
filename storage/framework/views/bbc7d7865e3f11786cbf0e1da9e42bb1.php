<?php $__env->startSection('title', 'Tài khoản học viên'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="page-card">
        <div style="display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:14px;">
            ...
            <a href="<?php echo e(route('admin.students.create')); ?>" class="btn-dark">+ Thêm mới</a>
        </div>
        ...
        <form method="get" style="display:flex;justify-content:flex-end;gap:10px;align-items:center;margin-bottom:14px;flex-wrap:wrap;">
            <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Tìm theo tên, email hoặc số điện thoại"
            ...
            <a href="<?php echo e(route('admin.students.index')); ?>" style="color:#1f2d3d;text-decoration:none;">Xóa lọc</a>
        </form>
        ...
        <div style="overflow:auto;">
            <table style="width:100%;border-collapse:collapse;">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="padding:12px;border-bottom:1px solid #f1f2f6;"><?php echo e($student->id); ?></td>
                        <td style="padding:12px;border-bottom:1px solid #f1f2f6;"><?php echo e($student->name); ?></td>
                        <td style="padding:12px;border-bottom:1px solid #f1f2f6;"><?php echo e($student->email); ?></td>
                        <td style="padding:12px;border-bottom:1px solid #f1f2f6;"><?php echo e($student->phone ?? '—'); ?></td>
                        ...
                        <td style="padding:12px;border-bottom:1px solid #f1f2f6;"><?php echo e($student->created_at?->format('d/m/Y')); ?></td>
                        <td style="padding:12px;border-bottom:1px solid #f1f2f6;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
                            ...
                            <a href="<?php echo e(route('admin.students.edit', $student)); ?>" style="padding:8px 10px;border-radius:8px;border:1px solid #e6ecf5;text-decoration:none;">Sửa</a>
                            <form action="<?php echo e(route('admin.students.destroy', $student)); ?>" method="post" onsubmit="return confirm('Xóa tài khoản này?');">
                                <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentStudentId = null;
        ...
        const fetchCourses = async (studentId) => {
            ...
            const res = await fetch(`<?php echo e(url('/admin/students')); ?>/${studentId}/courses-json`);
    ...
    if (assignSave) {
        assignSave.addEventListener('click', async () => {
            ...
            assignStatus.classList.add('d-none');
            try {
                const res = await fetch(`<?php echo e(url('/admin/students')); ?>/${currentStudentId}/courses-sync`, {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\online-om\resources\views/admin/students/index.blade.php ENDPATH**/ ?>