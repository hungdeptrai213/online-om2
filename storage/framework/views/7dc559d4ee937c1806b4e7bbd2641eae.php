...
<body class="overflow-x-hidden">
    ...
    <li class="nav-item">
        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link', 'fs-2', 'me-xl-4', 'mon-alt', 'active' => request()->routeIs('student.home')]); ?>" href="<?php echo e(route('student.home')); ?>">Khóa Học</a>
    </li>
    <li class="nav-item">
        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link', 'fs-2', 'me-xl-4', 'mon-alt', 'active' => request()->routeIs('student.coaching')]); ?>" href="<?php echo e(route('student.coaching')); ?>">Coaching</a>
    </li>
    <li class="nav-item">
        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link', 'fs-2', 'me-xl-4', 'mon-alt', 'active' => request()->routeIs('student.schedule')]); ?>" href="<?php echo e(route('student.schedule')); ?>">Lịch Học</a>
    </li>
    <li class="nav-item">
        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link', 'fs-2', 'me-xl-4', 'mon-alt', 'active' => request()->routeIs('student.enterprise')]); ?>" href="<?php echo e(route('student.enterprise')); ?>">Gói Doanh Nghiệp</a>
    </li>
    <li class="nav-item">
        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link', 'fs-2', 'me-xl-4', 'mon-alt', 'active' => request()->routeIs('student.materials')]); ?>" href="<?php echo e(route('student.materials')); ?>">Tài Liệu</a>
    </li>
...
<?php /**PATH C:\xampp\htdocs\online-om\resources\views\student\home.blade.php ENDPATH**/ ?>