                            ...
                            <tr>
                                ...
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <p class="fs-3 mb-1"><?php echo e($document->title); ?></p>
                                            ...
                                            <p class="fs-4 mb-0">
                                                <?php $__currentLoopData = $document->topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="me-2">#<?php echo e($topic->name); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </p>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-nowrap price-cell"><?php echo e($displayPrice); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<hr>
                        ...
                        <div class="page-card mt-4">
                            ...
                            <form id="documentPurchaseForm" class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="notes" class="form-control fs-3" rows="3" placeholder="Ghi chú thêm cho nhân viên"><?php echo e(old('notes')); ?></textarea>
                                </div>
            ...
            <div class="col-lg-3 d-flex flex-column mb-6">
                ...
                <div
                    ...
                    <p class="text-center fs-3 fw-bold mb-0"><?php echo e($displayPrice); ?></p>
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        <img class="w-75 mx-auto"
                            src="https://img.vietqr.io/image/mb-163448866-compact2.jpg?amount=<?php echo e($rawPrice); ?>&addInfo=<?php echo e($transferNote); ?>"
                            alt="QR Thanh toán">
                    </div>
                    ...
                    <p class="text-center fs-4 mb-0">Nội dung: <?php echo e($transferNote); ?></p>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const documentConfirmUrl = <?php echo json_encode(route('student.documents.cart.confirm', ['document' => $document->id]), 512) ?>;
        const rawDocumentPrice = <?php echo e($rawPrice); ?>;
        const transferNoteDocument = '<?php echo e($transferNote); ?>';
        const csrfToken = '<?php echo e(csrf_token()); ?>';
        const materialsRoute = <?php echo json_encode(route('student.materials'), 15, 512) ?>;
...
<?php echo $__env->make('student.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\online-om\resources\views/student/document-cart.blade.php ENDPATH**/ ?>