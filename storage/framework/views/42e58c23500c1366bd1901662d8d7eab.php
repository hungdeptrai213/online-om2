...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input id="password" type="password" name="password"
               ...
               style="width:100%;padding:12px 14px;border:1px solid #e3e8f1;border-radius:8px;margin-top:6px;"
               placeholder="<?php echo e(isset($user) ? 'Để trống nếu không đổi' : ''); ?>">
...
<div style="margin-top:18px;display:flex;gap:10px;">
    ...
    <a href="<?php echo e(route('admin.users.index')); ?>" style="padding:10px 16px;border-radius:8px;border:1px solid #e3e8f1;color:#1f2d3d;text-decoration:none;">Hủy</a>
</div>
<?php /**PATH C:\xampp\htdocs\online-om\resources\views\admin\users\form.blade.php ENDPATH**/ ?>