...
<?php $__env->startSection('content'); ?>
    <div class="page-card" style="max-width: 900px; margin: 0 auto;">
        <div style="display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:14px;">
            ...
            <a href="<?php echo e(route('admin.courses.index')); ?>" class="btn-dark"
        ...
        <form method="post" action="<?php echo e(route('admin.courses.update', $course)); ?>" enctype="multipart/form-data"
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="price"
                        value="<?php echo e(old('price', $course->price)); ?>" required
                        style="width:100%;margin-top:6px;padding:10px 12px;border:1px solid #e3e8f1;border-radius:10px;">
                </div>
                <div>
                    <label style="font-weight:700;">Giá khuyến mãi</label>
                    <input type="number" step="0.01" min="0" name="sale_price"
                        value="<?php echo e(old('sale_price', $course->sale_price)); ?>"
                        style="width:100%;margin-top:6px;padding:10px 12px;border:1px solid #e3e8f1;border-radius:10px;">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="published_at"
                        value="<?php echo e(old('published_at', optional($course->published_at)->format('Y-m-d\TH:i'))); ?>"
                        style="width:100%;margin-top:6px;padding:10px 12px;border:1px solid #e3e8f1;border-radius:10px;">
                </div>
            </div>
                ...
                <div style="overflow: hidden;">
                    ...
                    <label for="thumbInput"
                        ...
                        <i class="fa-solid fa-image"></i> <span
                            id="thumbFileName"><?php echo e($thumbUrlSafe ? basename($thumbUrlSafe) : 'Chọn ảnh'); ?></span>
                    </label>
                    <div style="margin-top:8px;">
                        <img id="thumbPreview" src="<?php echo e($thumbUrlSafe); ?>" alt="Preview"
                            data-has-initial="<?php echo e($thumbUrlSafe ? '1' : ''); ?>"
                            style="max-width:200px;border-radius:10px;<?php echo e($thumbUrlSafe ? '' : 'display:none;'); ?>border:1px solid #e6ecf5;padding:4px;">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="short_description" rows="3"
                    style="width:100%;margin-top:6px;padding:10px 12px;border:1px solid #e3e8f1;border-radius:10px;"><?php echo e(old('short_description', $course->short_description)); ?></textarea>
            </div>

            <div>
                <label style="font-weight:700;">Nội dung chi tiết</label>
                <textarea name="description" rows="6"
                    style="width:100%;margin-top:6px;padding:10px 12px;border:1px solid #e3e8f1;border-radius:10px;"><?php echo e(old('description', $course->description)); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\online-om\resources\views/admin/courses/edit.blade.php ENDPATH**/ ?>