...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('om-front/img/Logo Organic Marketing small (1).png')); ?>">
...
<div class="layout">
    <aside class="sidebar">
        ...
        <div class="nav-group">
            ...
            <div class="nav-item has-children <?php echo e($userActive ? 'active' : 'collapsed'); ?>">
                <i class="fa-solid fa-user-shield"></i>
                <span class="nav-label">Tài khoản Admin</span>
                <i class="fa-solid fa-chevron-right chevron"></i>
            </div>
            <div class="nav-sub <?php echo e($userActive ? '' : 'hide'); ?>">
                <a class="<?php echo e($userActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.users.index')); ?>">
            ...
            <div class="nav-item has-children <?php echo e($studentActive ? 'active' : 'collapsed'); ?>">
                <i class="fa-solid fa-user-graduate"></i>
                <span class="nav-label">Tài khoản học viên</span>
                <i class="fa-solid fa-chevron-right chevron"></i>
            </div>
            <div class="nav-sub <?php echo e($studentActive ? '' : 'hide'); ?>">
                <a class="<?php echo e($studentActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.students.index')); ?>">
            ...
            <div class="nav-item has-children <?php echo e($categoryActive ? 'active' : 'collapsed'); ?>">
                <i class="fa-solid fa-layer-group"></i>
                <span class="nav-label">Danh mục khóa học</span>
                <i class="fa-solid fa-chevron-right chevron"></i>
            </div>
            <div class="nav-sub <?php echo e($categoryActive ? '' : 'hide'); ?>">
                <a class="<?php echo e(request()->routeIs('admin.categories.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.categories.index')); ?>">
                    <span class="triangle"></span> Danh sách danh mục
                </a>
                <a class="<?php echo e(request()->routeIs('admin.categories.create') ? 'active' : ''); ?>" href="<?php echo e(route('admin.categories.create')); ?>">
                    <span class="triangle"></span> Thêm danh mục
                </a>
            </div>
            <a class="nav-item" href="<?php echo e(route('admin.courses.index')); ?>">
                <i class="fa-solid fa-book-open-reader"></i>
                <span class="nav-label">Khóa học</span>
                <span class="nav-badge">Chương/Bài</span>
            </a>
            <a class="nav-item <?php echo e($formActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.forms.index')); ?>">
                <i class="fa-solid fa-clipboard-list"></i>
                <span class="nav-label">Form đăng ký</span>
            </a>
            <a class="nav-item <?php echo e($scheduleActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.schedules.index')); ?>">
                <i class="fa-solid fa-calendar-days"></i>
                <span class="nav-label">Lịch học</span>
            </a>
            <div class="nav-item has-children <?php echo e($documentGroupActive ? 'active' : 'collapsed'); ?>">
                <i class="fa-solid fa-folder-open"></i>
                <span class="nav-label">Tài liệu</span>
                <i class="fa-solid fa-chevron-right chevron"></i>
            </div>
            <div class="nav-sub <?php echo e($documentGroupActive ? '' : 'hide'); ?>">
                <a class="<?php echo e($documentActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.documents.index')); ?>">
                    <span class="triangle"></span> Danh sách tài liệu
                </a>
                <a class="<?php echo e($documentTopicActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.document-topics.index')); ?>">
                    <span class="triangle"></span> Chủ đề tài liệu
                </a>
            </div>
            <a class="nav-item <?php echo e($commentActive ? 'active' : ''); ?>" href="<?php echo e(route('admin.comments.index')); ?>">
            ...
            <div class="top-actions">
                ...
                <div class="user-menu" id="userMenu">
                    ...
                    <div class="user-dropdown" role="menu">
                        ...
                        <a class="dropdown-link" href="<?php echo e(route('admin.profile.edit')); ?>">
...
<?php /**PATH C:\xampp\htdocs\online-om\resources\views/layouts/admin.blade.php ENDPATH**/ ?>