...
@section('content')
    <div class="page-card" style="max-width: 720px; margin: 0 auto;">
        ...
        <form method="POST" action="{{ route('admin.profile.update') }}" style="display:grid; gap:14px;">
            @csrf
            @method('PUT')
            ...
            <div style="display:flex; gap:10px;">
                ...
                <a href="{{ route('admin.dashboard') }}" style="padding:10px 16px; border-radius:8px; border:1px solid #dce3ef; text-decoration:none; color:#1f2d3d; background:#f7f9fc; font-weight:600;">
                    Hủy
                </a>
            </div>
        </form>
