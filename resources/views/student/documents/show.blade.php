    ...
    <div class="container-fluid px-2 px-md-3 px-lg-4">
        <div class="document-detail-modal">
            <div class="document-detail-header d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
                ...
                <a href="{{ route('student.materials') }}" class="btn btn-outline-dark" style="border-radius:999px;">← Trở về kho tài liệu</a>
            </div>
                    ...
                    <div class="book-frame" id="bookFrame">
                        ...
                        <div class="flipbook-stage">
                            <div class="book-lock-overlay" id="lockOverlay">
                                ...
                                <a href="{{ route('student.documents.cart', ['document' => $document->id]) }}" class="btn btn-success mt-2 px-4">Mua tài liệu</a>
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="info-panel">
                        ...
                        <div>
                            ...
                            <p class="info-meta mb-1">Ngày phát hành: {{ $document->published_at ? $document->published_at->format('d/m/Y') : 'Chưa rõ' }}</p>
                            <p class="fs-5 mb-1">
                        ...
                        <div class="d-grid">
                            @if($document->price > 0)
                                @if($isPurchased)
                                    <a href="{{ $document->link }}" target="_blank" rel="noreferrer" class="btn btn-success">Tải tài liệu bạn đã mua</a>
                                @else
                                    <a href="{{ route('student.documents.cart', ['document' => $document->id]) }}" class="btn btn-primary">Mua tài liệu</a>
                                @endif
                            @else
                                <a href="{{ $document->link }}" id="freeDownloadBtn" data-download-link="{{ $originalLink }}" class="btn btn-success">Tải miễn phí</a>
                            @endif
                        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const coverUrl = @json($document->thumbnail ?: asset('om-front/img/Open Document.png'));
