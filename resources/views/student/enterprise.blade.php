        ...
        <div class="row gx-5 justify-content-between">
            ...
            <div class="col-lg-6 pe-xl-5 mb-5">
                <div class="custom-bg-4 p-5 d-flex justify-content-center flex-column rounded-5 form-2-container shadow-sm">
                    ...
                    <form class="form-2 ms-auto me-auto" method="post" action="{{ route('student.enterprise.submit') }}">
                        @csrf
                        <div class="mb-3">
                            <input name="company" type="text" class="form-control p-2 shadow-sm rounded-4 fs-4 ps-3"
                                value="{{ old('company') }}" placeholder="Tên công ty" required>
                        </div>
                        <div class="mb-3">
                            <input name="contact_name" type="text" class="form-control p-2 shadow-sm rounded-4 fs-4 ps-3"
                                value="{{ old('contact_name') }}" placeholder="Người đại diện liên hệ" required>
                        </div>
                        <div class="mb-3">
                            <input name="contact_phone" type="text"
                                class="form-control p-2 shadow-sm rounded-4 fs-4 ps-3" value="{{ old('contact_phone') }}"
                        ...
                        <div class="mb-3">
                            <input name="employee_count" type="text"
                                class="form-control p-2 shadow-sm rounded-4 fs-4 ps-3" value="{{ old('employee_count') }}"
                                placeholder="Số lượng nhân sự đào tạo" required>
                        </div>
                        <div class="mb-3">
                            <textarea name="message" placeholder="Nội dung bạn muốn đào tạo"
                                class="w-100 p-2 bg-transparent border-0 shadow-sm rounded-4 fs-4 ps-3 " required>{{ old('message') }}</textarea>
                        </div>
